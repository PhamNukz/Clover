    ...
    return (
        <div className="p-8">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h2 className="text-3xl font-bold text-gray-800">Colaboradores</h2>
                        ...
                        {filteredEmployees.map((employee) => {
                            ...
                            return (
                                <div key={employee.id} className="group transition-colors hover:bg-gray-50">
                                    ...
                                    {isExpanded && (
                                        <div className="bg-gray-50 p-4 pl-16 border-t border-gray-200 animate-slideDown overflow-hidden">
                    ...
                    <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-xl font-bold">
                                {editingEmployee ? 'Editar Colaborador' : 'Agregar Colaborador'}
                            </h3>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    <select
                                        value={['Administración', 'Operaciones', 'Colaborador', 'Externo'].includes(formData.role || '') ? formData.role : 'Otro'}
                                        onChange={(e) => {
                                    ...
                                    {(!['Administración', 'Operaciones', 'Colaborador', 'Externo'].includes(formData.role || '') || formData.role === '') && (
                                        <input
                                            type="text"
